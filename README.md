# Networking-in-Azure
Just as the title implies this is implementation of creating a virtual network on azure and attaching resources to it, Resource could be a virtual machine , or SQl server.
...
There several ways of creating a virtual network
one way is to simple click the virtual network on the azure services tab
...
A second use the search bar to look for virtual networks
...
The other could also be create the vresource which will further prompt you to create a virtual network netork
...
Azure gives a default private IP address, however this can be customized and you can select you own priate ip to use.
